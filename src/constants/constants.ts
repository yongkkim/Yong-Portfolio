...
export const aboutInto = [
  {
    imgSrc: "/myHighSchool.jpg",
    imgAlt: "In High School",
    imgText: "In High School",
    popup: beforeCollegeInfo,
  },
  {
    imgSrc: "/campus.jpg",
    imgAlt: "In College",
